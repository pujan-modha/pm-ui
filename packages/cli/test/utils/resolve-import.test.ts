...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/pujan-modha/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/pujan-modha/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/pujan-modha/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/pujan-modha/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/pujan-modha/Projects/foobar/lib/utils")
})
...
test("resolve import with base url", async () => {
  ...
  expect(await resolveImport("@/registry/default/ui", config)).toEqual(
