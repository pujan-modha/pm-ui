    ...
    <>
      ...
      <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col p-10 lg:flex">
          <div className="absolute inset-0 border-r-2 bg-popover" />
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;I love shadcn/ui. Thank you{" "}
                <a
                ...
                for making this library.&rdquo;
              </p>
              <footer className="text-sm">Pujan Modha</footer>
            </blockquote>
          </div>
        </div>
