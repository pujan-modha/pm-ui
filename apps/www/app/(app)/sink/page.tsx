...
import BadgeOutline from "@/registry/default/example/badge-filled"
...
import ButtonFilled from "@/registry/default/example/button-filled"
          ...
          <div className="grid gap-4">
            ...
            <ComponentWrapper
              className="spa flex-col items-start space-x-0
				space-y-2"
            >
              <p className="text-sm text-primary">Documentation</p>
