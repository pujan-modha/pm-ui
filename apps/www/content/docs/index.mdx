---
title: Introduction
description: Beautifully themed components for your next React project. Built with Tailwind CSS.
---
...
You can use any framework that supports React. [Next.js](https://ui.pujan.pm/docs/installation/next), [Astro](https://ui.pujan.pm/docs/installation/astro), [Remix](https://ui.pujan.pm/docs/installation/remix), [Gatsby](https://ui.pujan.pm/docs/installation/gatsby) etc.
