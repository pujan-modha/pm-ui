...
```bash
npx @pujan-modha/pm-ui@latest add [component]
```
...
```txt
Usage: pm-ui add [options] [components...]
...
```bash
npx @pujan-modha/pm-ui diff alert
```
...
```txt
Usage: pm-ui diff [options] [component]
