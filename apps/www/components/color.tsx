  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-center justify-center gap-1">
        <span className="hidden font-mono text-xs tabular-nums text-primary transition-colors group-hover:text-primary lg:flex">
          {color.className}
        </span>
        <span className="font-mono text-xs tabular-nums text-primary transition-colors group-hover:text-primary lg:hidden">
          {color.scale}
        </span>
      </div>
    </button>
