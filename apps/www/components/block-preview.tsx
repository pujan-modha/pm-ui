...
import { Tabs, TabsContent } from "@/registry/default/ui/tabs"
        ...
        <ResizablePanelGroup direction="horizontal" className="relative z-10">
          <ResizablePanel
            ...
            className={cn(
              ...
              isLiftMode ? "border-primary/50" : "border-primary"
            )}
            defaultSize={100}
            minSize={30}
          >
            {isLoading ? (
              <div className="absolute inset-0 z-10 flex h-[--container-height] w-full items-center justify-center gap-2 bg-background text-sm text-primary">
