...
export function ChartToolbar({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <div className="flex items-center gap-1.5 pl-1 text-[13px] text-primary [&>svg]:h-[0.9rem] [&>svg]:w-[0.9rem]">
      ...
      <div className="ml-auto flex items-center gap-2 [&>form]:flex">
        <BlockCopyButton
          ...
          name={chart.name}
          code={chart.code}
          className="[&_svg]-h-3 h-6 w-6 rounded-[6px] bg-transparent text-primary shadow-none hover:bg-muted dark:text-primary [&_svg]:w-3"
        />
